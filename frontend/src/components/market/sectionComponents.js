...
// Screener/Movers/Sectores/Tendencia/Soportes-Resistencias/A revisar all
// move to, not a demotion - they're the same family as Radar itself);
// Activo stays a single-ticker deep dive, nothing else. Kept in a plain
// (non-component) module, not SectionedView.jsx itself, so Vite's fast
// refresh can still treat that file as component-only.
